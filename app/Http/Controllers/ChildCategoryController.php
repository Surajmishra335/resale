...
class ChildCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.admin.childcategory.index', compact('childcategories'));
    }
    ...
    {
        return view('backend.admin.childcategory.create');
    }
    ...
    public function store(ChildcategoryRequest $request)
    {
        ...
        return redirect()->back()->with('message', 'childcategory Created');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.admin.childcategory.edit', compact('childcategory'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('message', 'childcategory has been deleted');
    }
}

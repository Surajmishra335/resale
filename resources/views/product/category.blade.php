                ...
                <aside>
                    <div class="inner-box">
                        <div class="categories">
                            ...
                            <div class="categories-list" style="max-height: 250px; overflow-y:scroll;">
                                <ul>
                                    @foreach ($filterBySubcategory as $subcategoryName)
                                    @if ($subcategoryName)
                                    <li>
                                        <a
                                            href="{{url()->current()}}/{{($subcategoryName->slug) ?? ''}}">
                                            <i class="fas fa-desktop"></i>
                                            {{$subcategoryName->name}} <span

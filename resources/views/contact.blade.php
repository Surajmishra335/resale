    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-12 col-xs-12">
                <h2 class="title-2">Love to hear from you</h2>
                    ...
                    <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <input type="email" class="form-control" id="email"
                                            placeholder="you@yoursite.com" required data-error="Please enter your email"
                                            name="email" />
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea class="form-control" placeholder="Massage" rows="7"
            ...
            <div class="col-lg-4 col-md-12 col-xs-12">
                ...
                <div class="information">
                    <div class="contact-datails">
                        ...
                        <div class="info">
                            <h3>Address</h3>
                            <span class="detail">{{$setting->address}}</span>
                    ...
                    <div class="contact-datails">
                        ...
                        <div class="info">
                            <h3>Phone Numbers</h3>
                            <span class="detail">Main Office: {{$setting->phone}}</span>
                    ...
                    <div class="contact-datails">
                        ...
                        <div class="info">
                            <h3>Email Address</h3>
                            <span class="detail">Customer Support: {{$setting->mail}}</span>

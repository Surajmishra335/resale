        ...
        <div class="page-login-form box">
          ...
          <form  class="login-form" method="post" action="{{route('password.update')}}">
            ...
            <div class="form-group">
              <div class="input-icon">
                <i class="icon fas fa-unlock-alt"></i>
                <input type="password" class="form-control @error('password') is-invalid @enderror" placeholder="Confirm Password" name="password_confirmation" required autocomplete="new-password"/>
                
              </div>
            </div>
            <input type="hidden" name="token" value="{{request()->route('token')}}">
            <button class="btn btn-common log-btn" type="submit">Reset</button>
          </form>
          <ul class="form-links">
            <li class="float-left">
